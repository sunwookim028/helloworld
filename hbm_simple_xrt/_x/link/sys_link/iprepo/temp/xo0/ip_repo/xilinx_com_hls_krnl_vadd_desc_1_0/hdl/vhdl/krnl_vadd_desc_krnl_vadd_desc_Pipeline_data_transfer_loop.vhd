...
entity krnl_vadd_desc_krnl_vadd_desc_Pipeline_data_transfer_loop is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    num_words : IN STD_LOGIC_VECTOR (25 downto 0);
    sext_ln114 : IN STD_LOGIC_VECTOR (57 downto 0);
    sext_ln114_1 : IN STD_LOGIC_VECTOR (57 downto 0) );
end;


architecture behav of krnl_vadd_desc_krnl_vadd_desc_Pipeline_data_transfer_loop is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln114_fu_113_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal gmem0_addr_read_reg_163 : STD_LOGIC_VECTOR (511 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal i_fu_62 : STD_LOGIC_VECTOR (25 downto 0) := "00000000000000000000000000";
    signal add_ln114_fu_119_p2 : STD_LOGIC_VECTOR (25 downto 0);
    ...
    component krnl_vadd_desc_flow_control_loop_pipe_sequential_init IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    flow_control_loop_pipe_sequential_init_U : component krnl_vadd_desc_flow_control_loop_pipe_sequential_init
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => ap_start,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln114_fu_113_p2 = ap_const_lv1_0))) then 
    ...
    add_ln114_fu_119_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv26_1));
    ...
    begin
                ap_block_pp0_stage0_11001 <= (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_boolean_1 = ap_block_state2_pp0_stage0_iter1)) or ((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (m_axi_gmem2_WREADY = ap_const_logic_0)));
    end process;
    ...
    begin
                ap_block_pp0_stage0_subdone <= (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_boolean_1 = ap_block_state2_pp0_stage0_iter1)) or ((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (m_axi_gmem2_WREADY = ap_const_logic_0)));
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln114_fu_113_p2)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln114_fu_113_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    icmp_ln114_fu_113_p2 <= "1" when (ap_sig_allocacmp_i_1 = num_words) else "0";
    ...
    m_axi_gmem2_WDATA <= gmem0_addr_read_reg_163;
